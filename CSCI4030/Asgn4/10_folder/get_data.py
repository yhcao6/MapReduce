...
if os.path.isdir('10_folder_input'):
    os.system("rm -rf 10_folder_input")
os.system("mkdir 10_folder_input")
...
for i in range(n_folder):
    ...
    np.savetxt('10_folder_input/iter_{}/train_image.csv'.format(i),
               train_image, fmt='%f', delimiter=',')
    np.savetxt('10_folder_input/iter_{}/train_label.csv'.format(i),
               train_label, fmt='%f', delimiter=',')
    np.savetxt('10_folder_input/iter_{}/test_image.csv'.format(i),
               test_image, fmt='%f', delimiter=',')
    np.savetxt('10_folder_input/iter_{}/test_label.csv'.format(i),
