...
for turn in range(5):
    ...
    centroid_file = "res/iter_{}_centroid_points.txt".format(turn)
    test_img_file = "5_folder_input/iter_{}/test_image.csv".format(turn)
    test_label_file = "5_folder_input/iter_{}/test_label.csv".format(turn)
    turn_accuracies = []
